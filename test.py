...
'''
filename = '90epochs_01_1layer.sav'
...
def test_model():
    ...
    #Load the data and isolate test data
    dataset = 'mnist.pkl.qz'
    datasets = load_data(dataset)
    test_set_x,test_set_y = datasets[2]
    test_set_x = test_set_x.get_value()

    num_preds = 100
    preds = predict_model(test_set_y[:num_preds])
    print('Predicted digits for the first %s '/
